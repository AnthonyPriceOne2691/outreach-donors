 ...
 *  уже поля — видно на снимке. Один на все поля со списком; поле, которому
 *  нужна другая ширина, меняет только её (`comboboxProps` заменяет умолчание
 *  темы целиком, а не дополняет). */
