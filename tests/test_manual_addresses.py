...
class TestAdding:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "you@yourcompany.com",
                "Адрес you@yourcompany.com не записываем — домен-заглушка из примера на странице.",
            ),
            (
                "privacy@site.example.test",
                "Адрес privacy@site.example.test не записываем — чужой отдел: цену за "
                "размещение там не называют.",
            ),
