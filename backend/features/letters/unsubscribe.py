...
**Нечем подписать — ссылки нет вовсе.** Пустая строка вместо адреса
роняет отправку на проверке юридического блока. Подставить адрес без
метки было бы хуже всего: письмо выглядит законным, а кнопка отписки
в нём не работает ни для кого.
"""
